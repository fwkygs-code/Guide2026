      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-card rounded-xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">1. Plans and Pricing</h2>
              <p className="text-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">2. Free Trial</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">3. Payment Processing</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">4. Billing Cycle and Renewal</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">5. Cancellations</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">6. Failed Payments</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">7. Refund Policy</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">8. Downgrades and Plan Changes</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">9. Data Retention After Subscription Ends</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">10. Taxes</h2>
              <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">11. Changes to This Billing Policy</h2>
              <p className="text-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold text-foreground mb-4">12. Contact</h2>
              <p className="text-foreground leading-relaxed mb-4">
