...
export const INTERGUIDE_LOGO_MAIN_280_URL = `${CLOUDINARY_BASE}/video/upload/v1769839744/InterGuide_Logo.webm`;
export const INTERGUIDE_LOGO_MAIN_640_URL = `${CLOUDINARY_BASE}/video/upload/v1769839744/InterGuide_Logo.webm`;
export const INTERGUIDE_NEW_LOGO_280_URL = `${CLOUDINARY_BASE}/video/upload/v1769839744/InterGuide_Logo.webm`;
export const INTERGUIDE_NEW_LOGO_640_URL = `${CLOUDINARY_BASE}/video/upload/v1769839744/InterGuide_Logo.webm`;
export const INTERGUIDE_OG_IMAGE_URL = `${CLOUDINARY_BASE}/video/upload/v1769839744/InterGuide_Logo.webm`;
